...
(function (window, document, $) {
    ...
    $(".colors li").on("click", function () {
        ...
        if (!self.hasClass("active")) {
            ...
            if (skin.hasClass("skin-square")) {
                ...
                checkbox === undefined &&
                    ((checkbox = "icheckbox_square-red"),
                    (radio = "iradio_square-red"));
            }
            ...
            if (skin.hasClass("skin-flat")) {
                ...
                checkbox === undefined &&
                    ((checkbox = "icheckbox_flat-green"),
                    (radio = "iradio_flat-green"));
            }
            ...
            if (skin.hasClass("skin-line")) {
                ...
                checkbox === undefined &&
                    ((checkbox = "icheckbox_line-blue"),
                    (radio = "iradio_line-blue"));
            }

            checkbox === undefined &&
                ((checkbox = checkbox_default), (radio = radio_default));
    ...
    $("#chart1").sparkline(
        [
            5, 6, 7, 8, 9, 10, 12, 13, 15, 14, 13, 12, 10, 9, 8, 10, 12, 14, 15,
            16, 17, 14, 12, 11, 10, 8,
        ],
        {
            type: "bar",
