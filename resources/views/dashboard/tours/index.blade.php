...
@section('content')
    ...
    @include('dashboard.tours.modals.show-details')
@endsection
    ...
    <script type="text/javascript">
        ...
        function loadData(price = '', country_id = '', city_id = '', status = '') {
            ...
            $('#yajra-datatable').DataTable({
                ...
                ajax: {
                    url: '{!! route('dashboard.tours.get.all') !!}',
                    data: {
                        price: price,
        ...
        // delete
        $('body').on('click', '.delete_tour_btn', function(e) {
            e.preventDefault();
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: '{!! route('dashboard.tours.destroy', ':id') !!}'.replace(':id', id),
                        data: {
                            '_token': "{!! csrf_token() !!}"
                        },
                        type: 'DELETE',
        ...
        $('body').on('change', '.change_status', function(e) {
            ...
            $.ajax({
                url: "{{ route('dashboard.tours.change.status') }}",
                data: {
