                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea type="text" rows="5" id="details_ar" name="details[ar]" class="form-control"
                                                                        placeholder="{!! __('tickets.enter_details_ar') !!}"></textarea>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="details_en">{!! __('tickets.details_en') !!}</label>
                                                                    <textarea type="text" rows="5" id="details_en" name="details[en]" class="form-control "
                                                                        placeholder="{!! __('tickets.enter_details_en') !!}"></textarea>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <br />
                                                                    <select class="from_country_id_select form-control"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <br />
                                                                    <select class="to_country_id_select form-control"
