...
class CreateFlight extends Component
{
    ...
    // mount
    public function mount($countries, $cities, $categories)
    {
    ...
    public function firstStepSubmit()
    {
        $data = [
            ...
            'offer_duration_to' => ['required', 'date', 'after:offer_duration_from'],
    ...
    public function submitForm()
    {
        ...
        $flightCreated = $this->flightService->createFlight($basicData, $servicesData, $pricesData, $notesData, $offerIncludingData, $offerNotIncludingData, $this->images);
        ...
        if (!$flightCreated) {
            ...
            // $this->reset(['servicesItems', 'servicesNamesAr', 'servicesNamesEn']);
            $this->addNewService();
            $this->addNewPrice();
            $this->addNewNote();
    ...
    {
        return view('livewire.dashboard.flight.create-flight', [
